...
public class JettyCustomServer extends Server {
    ...
    private String resourceBase = "./src/main/webRoot";


    private String webXmlPath = "./src/main/webRoot/WEB-INF/web.xml";
    private String defaultWebXmlPath="./src/main/java/jetty/etc/webdefault.xml";
    ...
    public void applyHandle(Boolean warDeployFlag){
        ...
        webapp.setDefaultsDescriptor(defaultWebXmlPath);
    ...
    public static void main(String[] args) {
        ...
        JettyCustomServer server = new JettyCustomServer("./src/main/java/jetty/etc/jetty.xml","/testContext");
